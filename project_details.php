...
while($stmt->fetch()) {
	echo '<li><a href="resources_list.php?rid='.$rid.'">'.$rnam.','.$rtnam.'</a>';
...
while($stmt->fetch()) {
echo '<li><a href="client_details.php?cid='.$cid.'">'.$cnam.'</a></li>';
}
?>
<br><br><br>
<a href="project_list.php?pid=<?=$pid?>">Back to Projectlist</a><br>
